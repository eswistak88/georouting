...
void NewBaseApplLayer::initialize(int stage)
{
...
simtime_t NewBaseApplLayer::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void NewBaseApplLayer::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void NewBaseApplLayer::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void NewBaseApplLayer::handlePositionUpdate(cObject* obj)
{
...
void NewBaseApplLayer::handleParkingUpdate(cObject* obj)
{
    isParked = mobility->getParkingState();
}

void NewBaseApplLayer::handleLowerMsg(cMessage* msg)
{
...
void NewBaseApplLayer::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
...
NewBaseApplLayer::~NewBaseApplLayer()
{
...
void NewBaseApplLayer::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void NewBaseApplLayer::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void NewBaseApplLayer::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDown(msg);
}

void NewBaseApplLayer::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDelayedDown(msg, delay);
}

void NewBaseApplLayer::checkAndTrackPacket(cMessage* msg)
{
