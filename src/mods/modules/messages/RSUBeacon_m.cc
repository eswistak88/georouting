...
RSUBeacon::RSUBeacon(const char *name, short kind) : ::veins::DemoSafetyMessage(name,kind)
{
    this->POIID = 0;
}

RSUBeacon::RSUBeacon(const RSUBeacon& other) : ::veins::DemoSafetyMessage(other)
{
    copy(other);
}
...
void RSUBeacon::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->POIID);
}

void RSUBeacon::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::veins::DemoSafetyMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->POIID);
}

int RSUBeacon::getPOIID() const
{
    return this->POIID;
}

void RSUBeacon::setPOIID(int POIID)
{
    this->POIID = POIID;
}
...
RSUBeaconDescriptor::RSUBeaconDescriptor() : omnetpp::cClassDescriptor("veins::RSUBeacon", "veins::DemoSafetyMessage")
{
...
int RSUBeaconDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='P' && strcmp(fieldName, "POIID")==0) return base+0;
...
std::string RSUBeaconDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    RSUBeacon *pp = (RSUBeacon *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getPOIID());
        default: return "";
    }
}
...
bool RSUBeaconDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    RSUBeacon *pp = (RSUBeacon *)object; (void)pp;
    switch (field) {
        case 0: pp->setPOIID(string2long(value)); return true;
